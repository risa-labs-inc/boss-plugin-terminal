...
**Terminal (Dynamic)** (`ai.rever.boss.plugin.dynamic.terminal`) is a dynamic plugin for the BOSS desktop application.

Integrated terminal emulator

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.terminal`
- **Main Class**: `ai.rever.boss.plugin.dynamic.terminal.TerminalDynamicPlugin`
- **API Version**: 1.0.20
